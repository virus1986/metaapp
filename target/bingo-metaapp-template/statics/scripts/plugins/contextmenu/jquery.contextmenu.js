...
(function($) {
    ...
    $.fn._contextmenu = function(option) {
		...
		itemNoIconTpl = '<a href="#" class="contextmenu-a" style="text-decoration:none">\
						<div class="$[cssClass]" style="float:left;width:16px;height:16px;"></div>\
						<span class="context-menu-span">$[text]</span>\
		...
		var gTemplet = $("<ul></ul>").addClass("context-menu dropdown-menu b-m-mpanel").attr("unselectable", "on").css({"display":"none","z-index":9001});
        ...
        var buildItem = function(obj) {
            ...
            if(obj.icon&&(!obj["cssClass"]||obj["cssClass"]==="false")){
        ...
        var showMenuGroup = function(pos, width) {
            ...
            pos.left = (pos.left + width + mwidth > bwidth) ? (pos.left - mwidth < 0 ? 0 : pos.left - mwidth) : pos.left + width + fixLeft;
	...
	*/
	window.contextMenuWidget = function(){
		this.$ = null;
