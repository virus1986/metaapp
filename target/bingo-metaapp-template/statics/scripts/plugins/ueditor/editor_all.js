    ...
    EditorUI.prototype = {
        ...
        setFullScreen:function ( fullscreen ) {
            ...
            if ( this._fullscreen != fullscreen ) {
                ...
                if( uiUtils && uiUtils._beforefullscreenchange ){
                	uiUtils._beforefullscreenchange.call(this,fullscreen) ;
                }
                ...
                if( uiUtils && uiUtils._fullscreenchanged ){
                	uiUtils._fullscreenchanged.call(this,fullscreen) ;
                }
        ...
        _updateFullScreen:function () {
            if ( this._fullscreen ) {
                ...
                var vpRect = uiUtils.getViewportRect( this.getDom() );
                this.getDom().style.cssText = 'position:fixed;left:0;top:'+(this.editor.options.topOffset||0)+'px;width:' + vpRect.width + 'px;height:' + vpRect.height + 'px;z-index:' + (this.getDom().style.zIndex * 1 + 100);
                uiUtils.setViewportOffset( this.getDom(), { left:0, top:this.editor.options.topOffset||0 } , this.getDom()  );
