...
var directivesConfig=['angular','app','ngAnimate','ngSanitize',"usStrings","directives/uiAce",
                      ...
                      "directives/uiTab","directives/uiFormToolbar"];

var plugins=["plugins/focusTable",
             "plugins/htmleditor/singleItems","plugins/htmleditor/listItems",
             "plugins/htmleditor/tableItems"];

window.pd = null;

require(directivesConfig, function (angular,module) {
