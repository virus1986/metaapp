...
define(['angular',"directives/directives","services/appPd","common/utils",
        ...
        "directives/toolbar-editors/form/uiFormToolbarEditor"], function(angular,directiveModule,pd,utils) {
	var directiveName="pdEditor";
	var directive=directiveModule.directive(directiveName, ['$compile',"$animate","$timeout",function factory($compile,$animate,$timeout) {
		var directiveDef={};		
		var params={
			transclude: 'element',
			priority: 1000,
