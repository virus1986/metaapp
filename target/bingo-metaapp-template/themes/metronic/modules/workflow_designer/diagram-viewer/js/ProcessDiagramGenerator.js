 ...
 */
var ProcessDiagramGeneratorFactory={
		...
		var ProcessDiagramGenerator = {
				...
				init : function() {
					...
					this.activityDrawInstructions["startEvent"] = function() {
						...
						processDiagramCanvas.drawNoneStartEvent(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
						...
						if (label)
							processDiagramCanvas
									.drawLabel(activityImpl.getId(), label.text, label.x,
					...
					this.activityDrawInstructions["startTimerEvent"] = function() {
						...
						processDiagramCanvas.drawTimerStartEvent(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					};
					...
					this.activityDrawInstructions["startMessageEvent"] = function() {
						...
						var isInterrupting = activityImpl.getProperty("isInterrupting");
						processDiagramCanvas.drawMessageStartEvent(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					};
					...
					this.activityDrawInstructions["startSignalEvent"] = function() {
						...
						var isInterrupting = activityImpl.getProperty("isInterrupting");
						processDiagramCanvas.drawSignalStartEvent(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight(), isInterrupting);
					};
					...
					this.activityDrawInstructions["startMultipleEvent"] = function() {
						...
						var isInterrupting = activityImpl.getProperty("isInterrupting");
						processDiagramCanvas.drawMultipleStartEvent(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight(), isInterrupting);
					};
					...
					this.activityDrawInstructions["intermediateSignalCatch"] = function() {
						...
						var isInterrupting = activityImpl.getProperty("isInterrupting");
						processDiagramCanvas.drawCatchingSignalEvent(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
					...
					this.activityDrawInstructions["intermediateMessageCatch"] = function() {
						...
						var isInterrupting = activityImpl.getProperty("isInterrupting");
						processDiagramCanvas.drawCatchingMessageEvent(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight(), isInterrupting, null);
					...
					this.activityDrawInstructions["intermediateMultipleCatch"] = function() {
						...
						processDiagramCanvas.drawCatchingMultipleEvent(
								activityImpl.getId(), activityImpl.getProperty("name"),
					...
					this.activityDrawInstructions["intermediateSignalThrow"] = function() {
						...
						processDiagramCanvas.drawThrowingSignalEvent(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					...
					this.activityDrawInstructions["intermediateMessageThrow"] = function() {
						...
						processDiagramCanvas.drawThrowingMessageEvent(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					...
					this.activityDrawInstructions["intermediateThrowEvent"] = function() {
						...
						processDiagramCanvas.drawThrowingNoneEvent(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					...
					this.activityDrawInstructions["endEvent"] = function() {
						...
						processDiagramCanvas.drawNoneEndEvent(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					...
					this.activityDrawInstructions["errorEndEvent"] = function() {
						...
						processDiagramCanvas.drawErrorEndEvent(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight(), null);
					...
					this.activityDrawInstructions["messageEndEvent"] = function() {
						...
						processDiagramCanvas.drawMessageEndEvent(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight(), null);
					...
					this.activityDrawInstructions["signalEndEvent"] = function() {
						...
						processDiagramCanvas.drawSignalEndEvent(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight(), null);
					...
					this.activityDrawInstructions["multipleEndEvent"] = function() {
						...
						processDiagramCanvas.drawMultipleEndEvent(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight(), null);
					...
					this.activityDrawInstructions["terminateEndEvent"] = function() {
						...
						processDiagramCanvas.drawTerminateEndEvent(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					...
					this.activityDrawInstructions["errorStartEvent"] = function() {
						...
						processDiagramCanvas.drawErrorStartEvent(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					...
					this.activityDrawInstructions["userTask"] = function() {
						...
						var processDiagramCanvas = this.processDiagramCanvas;
						processDiagramCanvas.setConextObject(activityImpl);
						processDiagramCanvas.drawUserTask(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					};
					...
					// draft task
					this.activityDrawInstructions["draftTask"] = this.activityDrawInstructions["userTask"];
					...
					this.activityDrawInstructions["scriptTask"] = function() {
						...
						processDiagramCanvas.drawScriptTask(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					};
					...
					this.activityDrawInstructions["serviceTask"] = function() {
						...
						processDiagramCanvas.drawServiceTask(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					};
					...
					this.activityDrawInstructions["receiveTask"] = function() {
						...
						processDiagramCanvas.drawReceiveTask(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					};
					...
					this.activityDrawInstructions["sendTask"] = function() {
						...
						processDiagramCanvas.drawSendTask(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					};
					...
					// notify task
					this.activityDrawInstructions["notifyTask"] = this.activityDrawInstructions["sendTask"];
					...
					this.activityDrawInstructions["manualTask"] = function() {
						...
						processDiagramCanvas.drawManualTask(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					};
					...
					this.activityDrawInstructions["businessRuleTask"] = function() {
						...
						processDiagramCanvas.drawBusinessRuleTask(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					};
					...
					this.activityDrawInstructions["exclusiveGateway"] = function() {
						...
						processDiagramCanvas.drawExclusiveGateway(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					...
					this.activityDrawInstructions["inclusiveGateway"] = function() {
						...
						processDiagramCanvas.drawInclusiveGateway(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					...
					this.activityDrawInstructions["parallelGateway"] = function() {
						...
						processDiagramCanvas.drawParallelGateway(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					...
					this.activityDrawInstructions["eventBasedGateway"] = function() {
						...
						processDiagramCanvas.drawEventBasedGateway(activityImpl.getId(),
								activityImpl.getProperty("name"), activityImpl.getX(),
								activityImpl.getY(), activityImpl.getWidth(), activityImpl
										.getHeight());
					...
					this.activityDrawInstructions["boundaryTimer"] = function() {
						...
						var isInterrupting = activityImpl.getProperty("isInterrupting");
						processDiagramCanvas.drawCatchingTimerEvent(activityImpl.getId(),
								activityImpl.getX(), activityImpl.getY(), activityImpl
										.getWidth(), activityImpl.getHeight(),
								isInterrupting, null);
					...
					this.activityDrawInstructions["boundaryError"] = function() {
						...
						var isInterrupting = activityImpl.getProperty("isInterrupting");
						processDiagramCanvas.drawCatchingErrorEvent(activityImpl.getId(),
								activityImpl.getX(), activityImpl.getY(), activityImpl
										.getWidth(), activityImpl.getHeight(),
								isInterrupting, null);
					...
					this.activityDrawInstructions["subProcess"] = function() {
						...
						if (isExpanded != undefined && isExpanded == false) {
							processDiagramCanvas.drawCollapsedSubProcess(activityImpl
									.getId(), activityImpl.getProperty("name"),
									activityImpl.getX(), activityImpl.getY(), activityImpl
											.getWidth(), activityImpl.getHeight(),
									isTriggeredByEvent);
						} else {
					...
					$(document)
							.ready(
									function() {
										// Protect right click on SVG elements (and on
										// canvas too)
										document.body.oncontextmenu = function(event) {
											...
											if (!isIE678) {
												return (!Object
														.isSVGElement(window.event.srcElement));
											} else {
												return true;
											}
										};
				...
				funcDuration : function(cellval, unit) {
					...
					var numminutes = Math
							.floor((((secondsSum % 31536000) % 86400) % 3600) / 60);
					...
					if (unit == "d") {
						...
						cellval = (years + days + hours + minutes) ? (years + days + hours + minutes)
								: "1分钟";
					} else if (unit == "h") {
				...
				generateDiagram : function(processDefinitionDiagramLayout) {
					if(jQuery.isFunction(ProcessDiagramGenerator.beforeShow)){
						ProcessDiagramGenerator.beforeShow(processDefinitionDiagramLayout);
					}
					// Init canvas
					var processDefinitionId = processDefinitionDiagramLayout.processDefinition.id;
					var processIntanceId = processDefinitionDiagramLayout.processIntanceId;
					// console.log("Init canvas ", processDefinitionId);

					if (processDefinitionDiagramLayout.canvasHighLights)
						Canvas_HighlightsData = processDefinitionDiagramLayout.canvasHighLights;
					var processDiagram=this.getProcessDiagram(processIntanceId);
					if (processDiagram != undefined
							&& processDiagram != undefined) {
						...
						if(processDiagram['_diagramHolderId_']===this.options.diagramHolderId){
							return;
						}
					}
					...
					if (processDefinitionDiagramLayout.participantProcess != undefined) {
						...
						processDiagramCanvas.drawPoolOrLane(pProc.getId(), pProc.x,
								pProc.y, pProc.width, pProc.height, pProc.name);
					}
					...
					var pb1=this.options.processBar;
					pb1.set('value', 0);
					var cnt = 0;
					if (laneSets)
					...
					for ( var i in laneSets) {
						...
						task1.add(laneSet.lanes, function(task1, lane) {
							...
							processDiagramCanvas.drawPoolOrLane(lane.getId(), lane.x,
									lane.y, lane.width, lane.height, lane.name);
						});
					}
					...
					task1
							.add(
									activities,
									function(task1, activityJson) {
										var activity = new ActivityImpl(activityJson);
										for ( var i in processDefinitionDiagramLayout.activityInstances) {
											if (i == activity.id) {
												activity.instanceInfo = processDefinitionDiagramLayout.activityInstances[activity.id];
												break;
											}
										}
										activitiesLength--;
										...
										ProcessDiagramGenerator.drawActivity(
												processDiagramCanvas, activity);
									});
					...
					task1.add(sequenceFlows, function(task1, flow) {
						...
						processDiagramCanvas.drawSequenceflow(flowId, name, waypoints,
					...
					task1.onComplete(function() {
						if (progress < 100)
							pb1.set('value', 100);
						if(jQuery.isFunction(ProcessDiagramGenerator.afterShow)){
							ProcessDiagramGenerator.afterShow(processDefinitionDiagramLayout);
						}
					});
				...
				initProcessDiagramCanvas : function(processDefinitionDiagramLayout) {
					...
					if (diagramCanvas) {
						...
						var _diagramHolderId_=this.options.diagramHolderId;
						var diagramHolder = document.getElementById(_diagramHolderId_);
						if (!diagramHolder)
							throw {
						...
						var rightWith = minX > 0 ? minX : 0;
						var cWidth= maxX - minX + rightWith + 20;
						var cHeight= maxY - minY + 20;
						cWidth=cWidth<ProcessDiagramCanvas.$initCanvasWidth?ProcessDiagramCanvas.$initCanvasWidth:cWidth;
						cHeight=cHeight<ProcessDiagramCanvas.$initCanvasHeight?ProcessDiagramCanvas.$initCanvasHeight:cHeight;
						diagramCanvas.init(minX - 20, minY,cWidth,cHeight,processDefinitionDiagramLayout.processDefinition.id,div,ProcessDiagramGenerator);
						this.processDiagrams[processDefinitionDiagramLayout.processDefinition.id] = {
							...
							_diagramHolderId_:_diagramHolderId_
						};
					}
					return this
				...
				drawActivity : function(processDiagramCanvas, activity,
					...
					if (activity.getProperty("multiInstance") != undefined
						...
						var multiInstance = activity.getProperty("multiInstance");
						var collapsed = activity.getProperty("collapsed");
						processDiagramCanvas.drawActivityMarkers(activity.getId(), activity
								.getX(), activity.getY(), activity.getWidth(), activity
								.getHeight(), multiInstance, collapsed);
					}
					/*
				...
				drawHighLights : function(processInstanceId) {
					 ...
					 * });
					 */
					if (!Canvas_HighlightsData.historyActivities)
						ActivitiRest.getHighLights(processInstanceId, this._drawHighLights);
				},
				_drawHighLights : function(highLights) {
				...
				drawDiagram : function(processDefinitionId) {
					...
					// } else
					{
						this._drawDiagram(processDefinitionId);
					}
				},
				_drawDiagram : function(processDefinitionId) {
				...
				drawDiagramByInstanceId : function(processInstanceId) {
					// Hide all diagrams
					var diagrams = $("#" + this.options.diagramHolderId + " div.diagram");
					diagrams.addClass("hidden");
					...
					// } else
					{
						this._drawDiagramByInstanceId(processInstanceId);
					}
				},
				_drawDiagramByInstanceId : function(processInstanceId) {
					ProcessDiagramGenerator.addBreadCrumbsItem(processInstanceId);
					...
					if (processDiagram != undefined && processDiagram != null) {
						...
						var diagram = document.getElementById(processInstanceId);
						$(diagram).removeClass("hidden");
					...
					ActivitiRest.getProcessDefinitionByInstanceId(processInstanceId,
							ProcessDiagramGenerator._generateDiagramByInstanceId);
				},
				_generateDiagramByInstanceId : function(processDefinitionDiagramLayout) {
					...
					var pb1=ProcessDiagramGenerator.options.processBar;
					pb1.set('value', 0);
					ProcessDiagramGenerator.generateDiagram(processDefinitionDiagramLayout);
				},
				_generateDiagram : function(processDefinitionDiagramLayout) {
					// console.log("process-definition-diagram-layout["+processDefinitionDiagramLayout.processDefinition.id+"]:
					// ", processDefinitionDiagramLayout);
				...
				showFlowInfo : function(flow) {
					...
					var values = {
						...
						id : flow.id,
						name : flow.name,
						sourceId : flow.sourceActivityId,
						targetId : flow.destinationActivityId,
						isDefault : (flow.isDefault) ? "true" : "",
						isConditional : (flow.isConditional) ? "true" : "",
						isHighLighted : (flow.isHighLighted) ? "true" : ""
					};
					var TPL_FLOW_INFO = '<div><b>flow</b>: {flow}</div>'
							+ '<div><b>id</b>: {id}</div>'
							+ '<div><b>name</b>: {name}</div>'
							+ '<div><b>sourceId</b>: {sourceId}</div>'
							+ '<div><b>targetId</b>: {targetId}</div>'
