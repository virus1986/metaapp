define([ 'angular', 'services/services',"common/utils","common/classLoader"], function(angular, serviceModule,utils,classLoader) {
	...
	var service={};	
	var items=[
	           {name:"layouts",html:"布局控件",icon:"icon-text-width",href:"javascript://",active:false,items:[]},
	           {name:"controls",html:"基本控件",icon:"icon-desktop",href:"javascript://",active:false,items:[]},
	           {name:"fields",html:"实体字段",icon:"icon-edit",href:"javascript://",active:true,items:[]},
	           {name:"relations",html:"实体关系",icon:"icon-tag",href:"javascript://",active:false,items:[]},
	           {name:"templates",html:"表单分组",icon:"icon-dashboard",href:"javascript://",active:false,items:[]}
	          ];
	service.items=items;
	var flatItems={};
	...
	var createItem=service.createItem=function(parentName,instance){
		...
		//item拖动时用来判断是否接受拖入的dom函数true将不接受
		item.refuse=instance.refuse;
		item.items=[];
