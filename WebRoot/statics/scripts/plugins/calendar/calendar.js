...
function My97DP() {
    ...
    $d.innerHTML = '<div id=dpTitle><div class="NavImg NavImgll"><a href="###"></a></div><div class="NavImg NavImgl"><a href="###"></a></div><div style="float:left"><div class="menuSel MMenu"></div><input class="yminput  ui-widget-content"></div><div style="float:left"><div class="menuSel YMenu"></div><input class="yminput ui-widget-content"></div><div class="NavImg NavImgrr"><a href="###"></a></div><div class="NavImg NavImgr"><a href="###"></a></div><div style="float:right"></div></div><div style="position:absolute;overflow:hidden;background:#fff;"></div><div></div><div id=dpTime><div class="menuSel hhMenu"></div><div class="menuSel mmMenu"></div><div class="menuSel ssMenu"></div><table cellspacing=0 cellpadding=0 border=0><tr><td rowspan=2><span id=dpTimeStr></span>&nbsp;<input class="tB ui-widget-content" maxlength=2><input value=":" class="tm ui-widget-content" readonly><input class="tE ui-widget-content" maxlength=2><input value=":" class="tm ui-widget-content" readonly><input class="tE ui-widget-content" maxlength=2></td><td><button id=dpTimeUp></button></td></tr><tr><td><button id=dpTimeDown></button></td></tr></table></div><div id=dpQS></div><div id=dpControl><input class=dpButton id=dpClearInput type=button><input class=dpButton id=dpTodayInput type=button><input class=dpButton id=dpOkInput type=button></div>';
    attachTabEvent($d, 
    function() {
        hideSel();
    });
