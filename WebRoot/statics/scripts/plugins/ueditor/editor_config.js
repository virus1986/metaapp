...
(function($){
	$.uiwidget.register("ueditor",function(selector){
		/* 富文本编辑器的菜单模式，现在可选small，middle，large，分别对应精简版、普通版、完全版  */
		var mode = selector.attr('data-mode') || 'large', toolbars = null;
		switch(mode) {
		case 'large': toolbars = [['fullscreen', 'undo', 'redo', 'selectall', 'cleardoc', '|',
	            ...
	            'imagecenter', '|', 'inserttable','insertimage', 'emotion', 'insertvideo', 'attachment','template', '|',
	            'horizontal','snapscreen','source'
	            ]]; break;
		case 'middle': toolbars = [['fullscreen', 'undo', 'redo', '|',
	            'bold', 'italic', 'underline', 'strikethrough', 'removeformat', '|',
	            'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', '|', 'customstyle',
	            'paragraph', '|','fontfamily', 'fontsize', '|',
	            'indent','justifyleft', 'justifycenter', 'justifyright', 'justifyjustify','|',
	            'link', 'unlink', '|', 'imagenone', 'imageleft', 'imageright',
	            'imagecenter', '|', 'inserttable','insertimage', 'emotion', 'insertvideo',  '|',
	            'horizontal','snapscreen','source'
	            ]]; break;
		case 'small': toolbars = [['undo', 'redo', '|',
   	            'bold', 'italic', 'underline', '|',
	            'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', '|', 
	            'fontfamily', 'fontsize', '|',
	            'justifyleft', 'justifycenter', 'justifyright','|',
	            'link', 'unlink', '|', 'inserttable','emotion', '|',
	            'horizontal','source'
	            ]]; break;
	    }
		selector.each(function(){
			var me=$(this);
			var zIndex=900;
			var zIndexParent=me.closest(".ui-widget.ui-widget-content.ui-dialog").css("zIndex");
	        if(zIndexParent){
	        	zIndexParent=parseInt(zIndexParent);
	        }
	        if(zIndexParent>zIndex){
	        	zIndex=zIndexParent;
	        }
			reqModule(["ueditor"],function(){
				var options = me.attr( $.uiwidget.options )||"{}";
				eval(" var jsonOptions = "+options) ;
				jsonOptions.zIndex=zIndex;
				jsonOptions=$.extend(true, {
					focus: true,
					toolbars: toolbars			
				},jsonOptions);
	...
	window.UEDITOR_HOME_URL=window.UEDITOR_HOME_URL||_getBasePath();
})(jQuery) ;
