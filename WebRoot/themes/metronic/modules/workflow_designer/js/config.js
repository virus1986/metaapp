...
ORYX.CONFIG.MENU_INDEX = {"File" : 1, "Edit" : 2, "Undo": 3, "localstorage": 4, "Z-Order" : 5,  "Alignment": 6, "Grouping": 7, "lockunlockgroup": 8, "Docker" : 9, "colorpickergroup": 'AAA', "editprocessforms": 'BBB', 'sharegroup': 'CCC', "importgroup": 'DDD', "validationandsimulation": 'EEE', "servicerepogroup": 'FFF', "fullscreengroup": 'GGG', "Help" : "ZZZZZZ","BProps":"ZZZZZZZZ"};
...
ORYX.CONFIG.TYPE_COMBOBOX =				"combobox";
...
ORYX.CONFIG.TYPE_QUICKCANDIDATES =        "quickcandidates";
...
ORYX.CONFIG.PANEL_RIGHT_CANRESIZE = true;
ORYX.CONFIG.PANEL_LEFT_CANRESIZE = true;
...
ORYX.CONFIG.STENCIL_GROUP_ORDER = function() {
    var stencilObj = {
        "http://b3mn.org/stencilset/bpmn2.0#" : {
            ...
            "事件 (Events)": 15,
            "网关 (Gateways)": 17,
            "数据对象 (Data Objects)": 20,
            "泳道 (Swimlanes)": 21,
            "工件 (Artifacts)": 22,
            "流程模式 (Workflow Patterns)": 23,
            "Connecting Objects": 31,
            "Tasks": 32,
            "Service Tasks": 33,
            "Subprocesses": 34, 
            "Gateways": 35,
            "Start Events": 36,
            "End Events": 37,
            "Catching Intermediate Events": 38,
            "Throwing Intermediate Events": 39,
            "Data Objects": 40,
            "Swimlanes": 41,
            "Artifacts": 42,
