var Index = function () {
    ...
    return {
        ...
        initEasyPieChart:function(ctx){
        	ctx=ctx||$(document);
        	 $('.easy-pie-chart .number.transactions',ctx).easyPieChart({
                 animate: 1000,
                 size: 75,
                 lineWidth: 3,
             ...
             $('.easy-pie-chart .number.visits',ctx).easyPieChart({
                 animate: 1000,
                 size: 75,
                 lineWidth: 3,
             ...
             $('.easy-pie-chart .number.bounce',ctx).easyPieChart({
                 animate: 1000,
                 size: 75,
                 lineWidth: 3,
             ...
             $('.easy-pie-chart-reload',ctx).click(function(){
